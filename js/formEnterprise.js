...
$(function(){
    $('#add-restriction-button').on('click',function(){
        var r= $('<div class="form-group">'+
                   ...
                   '</select>'+
                  '<input id="addRule" class="btn btn-success" type="button" value="Añade esta restricción">'+
                  '</div> ');
...
function createContain(){
  ...
  var comp = '<label for = '+f+'> Debe de contener</label>'+
              ...
              '<input id="'+delet+'" class="btn btn-danger" type="button" value="Borrar">  <br for ="'+delet+'"/>'
